...
My TCP implenmentation is influenced by [nareddyt's answer on StackOverflow](https://stackoverflow.com/a/55432139).
...
## UDP
Interestingly, UDP offers no performance difference at all buffer sizes. Both the client and server have roughly 24 FPS. This illustrates the scalability of UDP and offers new possibilities to stream UDP across the web.
